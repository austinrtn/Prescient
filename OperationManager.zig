...
pub fn OperationManager(comptime components: []const Component) type {
    ...
    const RecordOperation = struct{ entity_record: EntityRecord, operation: Operation };
    const HashMap = HashMapType(EntityId, RecordOperation);
