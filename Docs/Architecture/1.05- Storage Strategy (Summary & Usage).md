...
# How To Use
You can select which storage strategy you want to use when defining entity pools within the [[1.07 - Pool Registry|Pool Registry]] within the [[1.02 - PoolConfig|PoolConfig]] struct.  Pass a `StorageStrategy.StorageStrategy` enum in the `storage_strategy` argument of PoolConfig.  Values of `StorageStrategy` are Sparse and Archetype. 
...
##### Next:  [[1.06 - Storage Strategy (Architecture)|Storage Strategy (Architecture)]]
# See Also
- [[1.00 - Entity Pools]] - How storage strategies fit into Entity Pools
- [[1.01 - Creating Entity Pools]] - Pool design best practices
- [[1.02 - PoolConfig]] - Configuring storage strategy in PoolConfig
- [[1.06 - Storage Strategy (Architecture)]] - Deep dive into storage strategy implementation
- [[Archetype]] - Archetype storage internals
- [[Sparse-Set]] - Sparse-Set storage internals
